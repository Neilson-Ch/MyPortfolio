...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Data science and analytics portfolio of Neilson Christopher." },
      { name: "author", content: "Neilson Christopher" },
      { property: "og:title", content: "Neilson Christopher — Data Science Portfolio" },
      { property: "og:description", content: "Machine learning, computer vision, generative modelling, and business intelligence projects." },
